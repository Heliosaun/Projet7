...
data_test_path = os.path.join(os.getcwd(), "../../data/data.csv")
data_train_path = os.path.join(os.getcwd(), "../../data/sample.csv")
...
model_path = os.path.join(os.getcwd(), "../model/model_opti_lgbm_final.pkl")
